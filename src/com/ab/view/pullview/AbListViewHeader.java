...
public class AbListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		LinearLayout.LayoutParams layoutParamsW1 = new LinearLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		layoutParamsW1.gravity = Gravity.CENTER;
		layoutParamsW1.width = AbViewUtil.scaleValue(mContext, 150);
		layoutParamsW1.height = AbViewUtil.scaleValue(mContext, 70);

		LinearLayout.LayoutParams layoutParamsW2 = new LinearLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		layoutParamsW2.gravity = Gravity.CENTER;
		layoutParamsW2.width = AbViewUtil.scaleValue(mContext, 250);
		layoutParamsW2.height = AbViewUtil.scaleValue(mContext, 70);
		
		LinearLayout headerLayout1 = new LinearLayout(context);
		headerLayout1.setOrientation(LinearLayout.VERTICAL);
		headerLayout1.setGravity(Gravity.CENTER);
		ImageView imageView1 = new ImageView(context);
		ImageView imageView2 = new ImageView(context);
		imageView1.setImageResource(R.drawable.shuaxin_mao);
		imageView2.setImageResource(R.drawable.shuaxin_wenzi);
		headerLayout1.addView(imageView1, layoutParamsW1);
		headerLayout1.addView(imageView2, layoutParamsW2);
